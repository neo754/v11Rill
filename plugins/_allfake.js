...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '62895360424437@s.whatsapp.net'), 'YaeMiko', 'https://chat.whatsapp.com/LI9mjrxzwcQCBE7eSJoEvy', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://chat.whatsapp.com/LI9mjrxzwcQCBE7eSJoEvy",					
				}
			}
		}
		global.fakeig = {
